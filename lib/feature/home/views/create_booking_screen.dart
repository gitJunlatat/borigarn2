...
import 'package:borigarn/core/widgets/app_bottom_button.dart';
      ...
      widget: Scaffold(
                  ...
                  children: [
                    ...
                    ButtonWidget(
                      onPressed: () {
                       ...
                       final location = ref.read(getLocationDefaultProvider).value;
                        ref.read(homeControllerProvider).createBooking(payload.createPayload(locale, location!.id!), locale);
                        // ref.read(homeControllerProvider).createBooking( locale);
          ...
          body: Consumer(
            builder: (BuildContext context, WidgetRef ref, Widget? child) {
              ...
              return ListView.builder(shrinkWrap: true, itemCount: (service.details?.length ?? 0) + 1, itemBuilder: (BuildContext context, int index) {
                ...
                switch (details[index].getFormType()) {
                  ...
                  case SelectFormType.dateTime:
                    return BookingDateTimePicker(detail: details[index],);
