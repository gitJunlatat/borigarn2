...
import 'package:borigarn/core/manager/dio_manager2.dart';
...
part 'network2.g.dart';

@Riverpod(keepAlive: true)
NetworkManager2 networkManager2(NetworkManager2Ref ref) {
  return NetworkManager2(ref.watch(dioClient2Provider));
}

class NetworkManager2 {
  final Dio _dio;

  NetworkManager2(this._dio);
